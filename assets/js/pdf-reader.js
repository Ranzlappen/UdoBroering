...
(function () {
  ...
  function failed(message) {
    if (!fallback) return;
    fallback.innerHTML =
      '<p>The in-browser reader couldn’t load.</p>' +
      '<p class="paper-reader__fallback-note"><a href="' + url + '" target="_blank" rel="noopener">Open the PDF</a> or <a href="' + url + '" download>download it</a>.</p>';
  }
