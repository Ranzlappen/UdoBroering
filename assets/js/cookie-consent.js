      ...
      '<div class="cc-banner__inner">' +
        ...
        '<div class="cc-banner__content">' +
          ...
          '<p class="cc-banner__desc">' +
            'This site loads two CDN libraries for optional features: search and ' +
            'charts. Essential functions (theme, preferences) always work without ' +
            'consent. You decide whether to enable the optional services.' +
          '</p>' +
        '</div>' +
        ...
        '<div class="cc-banner__settings" id="cc-settings" hidden>' +
          ...
          '<div class="cc-category">' +
            ...
            '</div>' +
            '<p class="cc-category__desc">' +
              'Lunr.js via unpkg CDN (full-text search) and Chart.js via jsDelivr ' +
              'CDN (charts on posts). Loaded only after you consent.' +
            '</p>' +
          '</div>' +
        '</div>' +
